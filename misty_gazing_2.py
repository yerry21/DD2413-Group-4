    ...
    def is_looking_at_robot(self, frame):
        ...
        if results.multi_face_landmarks:
            ...
            mp_drawing.draw_landmarks(
                image=frame, # The image frame
                landmark_list=face_landmarks, # Detected landmarks
                connections=mp.solutions.face_mesh.FACEMESH_CONTOURS, # Connections to draw
            ...
            if is_looking:
                ...
                x_tolerance = 1  # Tolerance for gaze-based movement
                y_tolerance = 5

                center_head_on_centroid(misty, x_offset, y_offset, pitch_step=6, yaw_step=12, x_tolerance=x_tolerance, y_tolerance=y_tolerance)
